...
//                            OctaveButton.setOctave(octaveView.getOctave());
    ...
    public void printBlankView() {
        NoteBlankView noteBlankView = new NoteBlankView(context);
        noteBlankView.setId(R.id.blank_view);
        ...
        noteBlankView.setLayoutParams(blkvlp);
        this.addView(noteBlankView);
    }
