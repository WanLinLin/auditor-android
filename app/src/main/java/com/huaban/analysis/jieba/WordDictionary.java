...
public class WordDictionary {
    private static final String LOG_TAG = WordDictionary.class.getName();
    ...
    private static final int DICT = R.raw.small_dict;
    ...
    public static WordDictionary getInstance(Context context) {
        WordDictionary.context = context;
        if (singleton == null) {
...
//    }
    ...
    public void loadDict() {
        ...
        InputStream is = context.getResources().openRawResource(DICT);
        try {
            ...
            Log.e(LOG_TAG, String.format(Locale.getDefault(), "main dict load finished, time elapsed %d ms",
                    System.currentTimeMillis() - s));
        }
        catch (IOException e) {
            Log.e(LOG_TAG, String.format(Locale.getDefault(), "%s load failure!", MAIN_DICT));
        }
        finally {
            try {
                if (null != is)
                ...
                Log.e(LOG_TAG, String.format(Locale.getDefault(), "%s close failure!", MAIN_DICT));
            }
        }
    }
