...
public class FinalSeg {
    private static final String LOG_TAG = FinalSeg.class.getName();
    ...
    public synchronized static FinalSeg getInstance(Context context) {
        FinalSeg.context = context;
    ...
    private void loadModel() {
        ...
        InputStream is = context.getResources().openRawResource(R.raw.prob_emit);
        try {
            ...
            Log.e(LOG_TAG, String.format(Locale.getDefault(), "%s: load model failure!", PROB_EMIT));
        }
        finally {
            try {
                if (null != is)
                ...
                Log.e(LOG_TAG, String.format(Locale.getDefault(), "%s: close failure!", PROB_EMIT));
            }
        }
        Log.e(LOG_TAG, String.format(Locale.getDefault(), "model load finished, time elapsed %d ms.",
